document.addEventListener("DOMContentLoaded", function () {
    ...
    const amountRadios = document.querySelectorAll('input[name="donationAmount"]:not([value="other"])');
    ...
    formulario.addEventListener("submit", function (evento) {
        ...
        const donationTypeSelected = document.querySelector('input[name="donationType"]:checked');
        const donationAmountSelected = document.querySelector('input[name="donationAmount"]:checked');
        ...
        if (!donationTypeSelected) {
            mostrarMensajeDeError("donationTypeError", "Selecciona un tipo de donación mensual/puntual.");
            formularioValido = false;
        }

        if (!donationAmountSelected) {
            mostrarMensajeDeError("donationAmountError", "Selecciona un cantidad de donación.");
            formularioValido = false;
        } else if (donationAmountSelected.value === "other" && customAmount === "") {
            mostrarMensajeDeError("donationAmountError", "Ingresa una cantidad valida para 'Otra'.");
            formularioValido = false;
        }
        ...
        if (!termsAccepted) {
            mostrarMensajeDeError("termsError", "Debes aceptar los términos y condiciones.");
            formularioValido = false;
        }
...
function mostrarModal(nombreDeServicio) {
    ...
    if (informacionDetallada.hasOwnProperty(nombreDeServicio)) {
        ...
        console.error("El servicio '" + nombreDeServicio + "' no tiene información detallada disponible.");
    }
}
